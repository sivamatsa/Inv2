...
(function () {
  ...
  async function renderDealsView() {
    ...
    async function draw() {
      ...
      const cols = [
        ['deal_name', 'Deal'], ['investment_type', 'Type'], ['invested_amount', 'Invested'],
      ...
      table.innerHTML = thead + `<tbody>${body || `<tr><td colspan="9" style="text-align:center;color:var(--text3);padding:24px">No deals yet.</td></tr>`}</tbody>`;
